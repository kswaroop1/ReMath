...
void main() {
  ...
  test('incorrect work is immediately due and slow work returns in five minutes', () {
  ...
  test('fluent recall expands review intervals through the retention ceiling', () {
  ...
  test('scheduler chooses due weakest work and otherwise the weakest future work', () {
    SkillFluency skill(
