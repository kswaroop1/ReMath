...
void main() {
  ...
  test('a learner is marked correct for the exact integer despite spacing', () {
    expect(answer.mark('12').verdict, AnswerVerdict.correct);
    expect(answer.mark('  12  ').verdict, AnswerVerdict.correct);
    expect(answer.mark('+12').verdict, AnswerVerdict.correct);
  });

  test('a different valid integer is marked incorrect rather than invalid', () {
  ...
  test('ambiguous or non-integer input is not treated as a wrong answer', () {
